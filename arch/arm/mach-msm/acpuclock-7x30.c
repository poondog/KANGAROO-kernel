...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 768000,  PLL_2, 3, 0, 192000000, 1000, VDD_RAW(1000), &pll2_tbl[0]},
	{ 1, 806400,  PLL_2, 3, 0, 192000000, 1050 VDD_RAW(1050), &pll2_tbl[1]},
	{ 1, 1024000, PLL_2, 3, 0, 192000000, 1100, VDD_RAW(1100), &pll2_tbl[2]},
	{ 1, 1200000, PLL_2, 3, 0, 192000000, 1150, VDD_RAW(1150), &pll2_tbl[3]},
	{ 1, 1305600, PLL_2, 3, 0, 192000000, 1200, VDD_RAW(1200), &pll2_tbl[4]},
