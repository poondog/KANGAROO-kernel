...
static struct pll pll2_tbl[] = {
	...
	{  73, 0, 1, 0 }, /* 1401 MHz */
        {  79, 0, 1, 0 }, /* 1516 MHz */
#if defined(CONFIG_HIGH_OC_VALUES)
	{  88, 1, 3, 0 }, /* 1708 MHz */
	{  93, 1, 3, 0 }, /* 1804 MHz */
#endif
};
